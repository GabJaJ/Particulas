...
function renderParticule(anim){
    for (var i = 0; i < anim.animatetables.length; i++){
        anim.animatetables[i].target.draw();
    }
}
...
var render = anime({
    duration: Infinity,
    update: function (){
        ctx.clearRect(0, 0, canvasE1.width, canvasE1.height);
    }
});
...
document.addEventListener(tap, function (e){
    ...
    render.play();
    updateCoords(e);
    animateparticulas(pointerX, pointerY);
}, false);
